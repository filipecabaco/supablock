defmodule Superblock.Paths do
  @moduledoc """
  XDG-style directory resolution for superblock's config and state files.
  """

  @spec config_dir() :: String.t()
  def config_dir do
    base = System.get_env("XDG_CONFIG_HOME") || Path.join(home(), ".config")
    Path.join(base, "superblock")
  end
  ...
  def log_file, do: Path.join(state_dir(), "superblock.log")
