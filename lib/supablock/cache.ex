defmodule Supablock.Cache do
  ...
  @doc "Drop every cache entry (used by `supablock refresh`)."
  def flush do
  ...
  @doc """
  Cache occupancy, used by `supablock refresh --check`: total entries and how
