defmodule Supablock.Credentials do
  @moduledoc """
  ...
  The `SUPABLOCK_TOKEN` environment variable overrides the stored credential
  ...
  FUSE-serving path (see `Supablock.RawFile`).
  """

  alias Supablock.{Paths, RawFile}
  ...
  def load_credential do
    case System.get_env("SUPABLOCK_TOKEN") do
