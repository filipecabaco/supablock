defmodule Superblock.BrowserLogin do
  @moduledoc """
  ...
  defp token_name do
    ...
    "superblock_#{user}@#{host}_#{System.os_time(:second)}"
  end

  defp dashboard_url do
    System.get_env("SUPERBLOCK_DASHBOARD_URL") || @dashboard_url
  end
